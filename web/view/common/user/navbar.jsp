        ...
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item px-2"><a class="nav-link fw-medium" href="#outlet">Outlet</a></li>
                    ...
                    <li class="nav-item px-2"><a class="nav-link fw-medium" href="#outlet">Manage Account</a></li>
                    <li class="nav-item px-2"><a class="nav-link fw-medium" href="#outlet">Manage Product</a></li>
                    </c:if>
            </ul>
            <!-- Cart button -->
