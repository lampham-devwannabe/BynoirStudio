<%-- 
    ...
    Created on : Mar 1, 2024, 2:16:50 PM
    Author     : lamph
--%>
        ...
        <jsp:include page="../common/user/navbar.jsp"></jsp:include>
            <div class="container-xl">
                <div class="table-responsive">
                    <div class="table-wrapper content1">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach items="${userList}" var="u">
                                <tr>
                                    ...
                                    <td>${u.user_email}</td>                        
                                    <td>
                                        <c:if test="${u.admin}">Admin</c:if>
                                        <c:if test="${!(u.admin)}">User</c:if>
                                        </td>
                                        <td style="display: flex">
                                            <form action="loadDetail" method="POST">
                                                <input type="hidden" name="edit_id" value="${u.user_id}">
                                        ...
                                        <form action="deleteAccount" method="POST">
                                            ...
                                            <button type="submit" class="edit" data-toggle="modal" style="background: none; border: none; cursor: pointer;"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE5C9;</i></button>
                                        </form>
                                    </td>
                                </tr>
                            </c:forEach>
